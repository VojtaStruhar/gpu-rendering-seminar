...
void Application::prepare_cameras() {
    ...
    // TASK 1: Initialize the projection and view matrices for the light camera using glm::perspective function.
...
void Application::update(float delta) {
    ...
    light_camera_view = glm::lookAt(glm::vec3(phong_lights_ubo.get_lights()[0].position), glm::vec3(phong_lights_ubo.get_lights()[0].position) + phong_lights_ubo.get_lights()[0].spot_direction,
    ...
    shadow_matrix =
        ...
        glm::translate(glm::mat4(1.0f), glm::vec3(0.5f)) * glm::scale(glm::mat4(1.0f), glm::vec3(0.5f)) * light_camera_projection * light_camera_view;
}
